 ...
 * @augments Camera
 */
class OrthographicCamera extends Camera implements ToJson implements GetType {
	 ...
	 */
	public function new( left = - 1, right = 1, top = 1, bottom = - 1, near = 0.1, far = 2000 ) {
	...
	public function copy( source, recursive ) {
