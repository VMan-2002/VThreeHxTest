...
import vman2002.vthreehx.textures.Data3DTexture;
import vman2002.vthreehx.textures.DataArrayTexture;
import vman2002.vthreehx.textures.DepthTexture;
...
class SingleUniform {
	...
	public function new( id, activeInfo, addr ) {
...
class StructuredUniform {
	...
	public function setValue( gl, value, textures ) {
...
class WebGLUniforms {
	...
	public function new( gl, program ) {
	...
	public function setValue( gl, name, value, textures ) {
	...
	public function setOptional( gl, object, name ) {
	...
	static public function  upload( gl, seq, values, textures ) {
	...
	static public function seqWithValue( seq, values ) {
