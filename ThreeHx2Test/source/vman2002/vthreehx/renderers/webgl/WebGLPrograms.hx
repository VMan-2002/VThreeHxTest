...
import vman2002.vthreehx.Constants.ObjectSpaceNormalMap;
...
import vman2002.vthreehx.renderers.webgl.WebGLProgram;
import vman2002.vthreehx.renderers.webgl.WebGLShaderCache;
...
function WebGLPrograms( renderer, cubemaps, cubeuvmaps, extensions, capabilities, bindingStates, clipping ) {
	...
	function getParameters( material, lights, shadows, scene, object ) {
		...
		var reverseDepthBuffer = renderer.state.buffers.depth.getReversed();
