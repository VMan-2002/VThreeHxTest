...
import vman2002.vthreehx.Constants.ACESFilmicToneMapping;
import vman2002.vthreehx.Constants.AddOperation;
import vman2002.vthreehx.Constants.AgXToneMapping;
import vman2002.vthreehx.Constants.CineonToneMapping;
...
import vman2002.vthreehx.Constants.CustomToneMapping;
import vman2002.vthreehx.Constants.GLSL3;
import vman2002.vthreehx.Constants.LinearToneMapping;
import vman2002.vthreehx.Constants.LinearTransfer;
import vman2002.vthreehx.Constants.MixOperation;
import vman2002.vthreehx.Constants.MultiplyOperation;
import vman2002.vthreehx.Constants.NeutralToneMapping;
import vman2002.vthreehx.Constants.NoToneMapping;
import vman2002.vthreehx.Constants.PCFShadowMap;
import vman2002.vthreehx.Constants.PCFSoftShadowMap;
import vman2002.vthreehx.Constants.ReinhardToneMapping;
...
import vman2002.vthreehx.renderers.webgl.WebGLShader;
...
function getEncodingComponents( colorSpace ) {
	...
	var encodingMatrix = 'mat3( ${ _m0.elements.map( ( v ) => v.toFixed( 4 ) ) } )';
...
var includePattern = new RegExp("^[ \\t]*#include +<([\\w\\d./]+)>", "gm");
	...
	function onFirstUse( self ) {
		...
		if ( renderer.debug.checkShaderErrors ) {
			...
			if ( gl.getProgramParameter( program, gl.LINK_STATUS ) == false ) {
				...
				if ( Reflect.isFunction(renderer.debug.onShaderError) ) {
